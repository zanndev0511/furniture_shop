$(document).ready(function () {
    ...
    $(".active-banner-slider").owlCarousel({
        ...
        nav: true,
        navText: [
            "<img src='/main/assets/img/banner/prev.png'>",
            "<img src='/main/assets/img/banner/next.png'>",
        ],
        dots: false,
    });
    ...
    $(".active-product-area").owlCarousel({
        ...
        nav: true,
        navText: [
            "<img src='/main/assets/img/product/prev.png'>",
            "<img src='/main/assets/img/product/next.png'>",
        ],
        dots: false,
    });
